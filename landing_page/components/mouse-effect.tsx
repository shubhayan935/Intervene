...
export default function MouseEffect() {
  ...
  const trailSpringsX = [
    useSpring(trailMotionX[0], {
      ...springConfig,
      stiffness: 300 - 0 * 40,
      damping: 20 + 0 * 5,
    }),
    useSpring(trailMotionX[1], {
      ...springConfig,
      stiffness: 300 - 1 * 40,
      damping: 20 + 1 * 5,
    }),
    useSpring(trailMotionX[2], {
      ...springConfig,
      stiffness: 300 - 2 * 40,
      damping: 20 + 2 * 5,
    }),
    useSpring(trailMotionX[3], {
      ...springConfig,
      stiffness: 300 - 3 * 40,
      damping: 20 + 3 * 5,
    }),
    useSpring(trailMotionX[4], {
      ...springConfig,
      stiffness: 300 - 4 * 40,
      damping: 20 + 4 * 5,
    }),
  ...
  const trailSpringsY = [
    useSpring(trailMotionY[0], {
      ...springConfig,
      stiffness: 300 - 0 * 40,
      damping: 20 + 0 * 5,
    }),
    useSpring(trailMotionY[1], {
      ...springConfig,
      stiffness: 300 - 1 * 40,
      damping: 20 + 1 * 5,
    }),
    useSpring(trailMotionY[2], {
      ...springConfig,
      stiffness: 300 - 2 * 40,
      damping: 20 + 2 * 5,
    }),
    useSpring(trailMotionY[3], {
      ...springConfig,
      stiffness: 300 - 3 * 40,
      damping: 20 + 3 * 5,
    }),
    useSpring(trailMotionY[4], {
      ...springConfig,
      stiffness: 300 - 4 * 40,
      damping: 20 + 4 * 5,
    }),
