      ...
      <div className="container relative px-4 md:px-6">
        ...
        >
          <motion.div
            ...
            className="inline-block rounded-full bg-gradient-to-r from-purple-600/10 to-violet-600/10 px-4 py-1.5 text-sm font-medium text-purple-300 backdrop-blur cursor-pointer hover:scale-110 transition-transform duration-300 border border-white/10 hover:border-white/20"
            
          >
            <a href="https://www.producthunt.com/posts/intervene" target="_blank" rel="noopener noreferrer">
